...
export default function Admin() {
    ...
    const form = <ReactRouterForm encType="multipart/form-data" method="POST">
    <Stack gap="2rem" mb="4rem">
        ...
        <TextField name="price" id="form-admin-product-price" value={product.price} onChange={e => handleChangePrice(e, setProduct)} label="Price" variant="outlined" required />
